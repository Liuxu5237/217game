...
function ShopLayer:getListItem(listType, index)
	...
	--商品数量
	local txtItemCount = cc.LabelAtlas:_create(itemCount, "Shop/sp_number_2.png", 20, 28, string.byte("0"))
	...
	local txtPrice = cc.LabelAtlas:_create(itemPrice, "Shop/sp_number_3.png", 22, 32, string.byte("0"))
