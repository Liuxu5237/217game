...
--ws://59.111.94.110:8099/  ws://ioslogin.game217.com:8099/
-- if device.platform == "ios" then
--     WebFrame._webSocket= WebSocket:create("ws://ioslogin.game217.com:8099/")     
-- else 
--     WebFrame._webSocket= WebSocket:create("ws://androidlogin.game217.com:8099/")  
-- end
...
function WebFrame:getInstance()
    ...
    if nil == g_webSocket then
        if device.platform == "ios" then
            g_webSocket= WebSocket:create("ws://ioslogin.game217.com:8099/")     
        else 
            g_webSocket= WebSocket:create("ws://androidlogin.game217.com:8099/")  
        end 
